                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group row mb-4">
                                    <div class="col-md-12">
                                        <img :src="imageSrc" class="imageShow" width="200px" height="400px"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" name="image" id="image" class="form-control"
                                            @change="imageUrl" />
                                        <p style="font-size: 11px;color: red;">Required size: 600 X 1200</p>
                                    </div>
                                </div>
                                <div class="form-group mt-2">
...
export default {
    ...
    methods: {
        getAdvertise() {
            axios.get(location.origin + "/admin/get-advertise-four")
                .then(res => {
                    this.form = res.data
                    this.imageSrc = res.data.image != null ? location.origin + "/" + res.data.image : location.origin + "/600x1200.jpg"
                })
        },
        ...
        updateAdvertise(event) {
            ...
            axios.post("/admin/advertise-four", formdata)
                .then(res => {
