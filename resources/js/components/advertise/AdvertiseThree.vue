                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group row mb-4">
                                    <div class="col-md-12">
                                        <img :src="imageSrc" class="imageShow" width="300px" height="300px"
...
export default {
    data() {
        return {
            ...
            imageSrc: location.origin + "/600x600.jpg",
        }
    },
    ...
    methods: {
        getAdvertise() {
            axios.get(location.origin + "/admin/get-advertise-three")
                .then(res => {
                    this.form = res.data
                    this.imageSrc = res.data.image != null ? location.origin + "/" + res.data.image : location.origin + "/600x600.jpg"
                })
        },
        ...
        updateAdvertise(event) {
            ...
            axios.post("/admin/advertise-three", formdata)
                .then(res => {
