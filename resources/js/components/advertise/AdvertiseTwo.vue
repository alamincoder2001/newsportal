                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="form-group row mb-4">
                                    <div class="col-md-12">
                                        <img :src="imageSrc" class="imageShow" width="100%" height="300px"
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="file" name="image" id="image" class="form-control"
                                            @change="imageUrl" />
                                        <p style="font-size: 11px;color: red;">Required size: 1200 X 300</p>
                                    </div>
                                </div>
                                <div class="form-group mt-2">
    ...
    methods: {
        getAdvertise() {
            axios.get(location.origin + "/admin/get-advertise-two")
                .then(res => {
                    this.form = res.data
                    this.imageSrc = res.data.image != null ? location.origin + "/" + res.data.image : location.origin + "/1200x300.jpg"
                })
        },
