...
return false;});});}
$(function(){$(".b-notes").notes(".b-notes");$("#calendar").datepicker({todayHighlight:true,weekStart:1,endDate:new Date(),startDate:new Date('2012-01-06'),}).on({'changeDate':function(e){if(typeof(e.date)=="undefined")return false;gtag('event','link',{'event_label':'Footer Archive','event_category':'click','non_interaction':true});var milliseconds=Date.parse(e.date);var date=new Date(milliseconds).format("yyyy/mm/dd");document.location.href='./archive/'+date;}});});