                    ...
                    <div class="col-xs-6">
                        <table _t92sadbc2>
                            <tr>
                                ...
                                <td style="text-align:right;font-weight:bold">{{ sales.SaleMaster_SubTotalAmount }}</td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td style="text-align:right;font-weight:bold">{{ sales.SaleMaster_TotalSaleAmount }}</td>
                            </tr>
                            <tr>
                                <td><strong>Paid:</strong></td>
                                <td style="text-align:right;font-weight:bold">{{ sales.SaleMaster_PaidAmount }}</td>
                            </tr>
                            <tr><td colspan="2" style="border-bottom: 1px solid #ccc"></td></tr>
                            <tr>
